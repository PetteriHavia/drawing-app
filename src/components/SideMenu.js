...
import { BiEraser, BiTrash, BiPencil, BiUndo, BiRedo } from "react-icons/bi";
import { ToolBar, SideBar } from "../styles/Elements.style";
import { addToHistory, addToredoHistory, changeTool, deleteFromHistory, deleteFromredoHistory, redoReducer } from "../redux/DrawingReducer";
